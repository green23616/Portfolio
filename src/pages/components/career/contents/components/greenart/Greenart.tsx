        ...
        <div className={styles.greenart__below__text}>
          ...
          <div className={styles.content}>
            <div>
              <h2>커뮤니케이션</h2>
              <h3>
                팀에 문제가 생겼을 때 대화를 통해 문제를 해결하고, 깔끔하게
                나아가는 분위기의 중요성을 알고 업무를 통해 경험해보아
                부조장으로서 업무 일정 관리와 의견 충돌 시 중재하는 역할을 맡아
                스터디와 팀 프로젝트를 이끌었습니다. <br />
                대화가 길어져도 분위기와 요점을 파악하고 정리하는 스킬을 통해 팀의
                분위기에 빠르게 적응하고 업무에 유연함을 더할 자신이 있습니다.
              </h3>
            </div>
            <div>
              <h2>기록하는 습관</h2>
              <h3>
                개발에 앞서 설계가 중요하듯, 어떤 업무에서든 일의 중요도에
                순위를 매기고 체계적으로 처리하는 프로세스는 매우 중요할
                것입니다.
                <br />
