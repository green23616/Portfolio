    ...
    <div className={styles.nandsoft}>
      <ul className={styles.container}>
        ...
        >
          ...
          >
            <h3>
              주도적으로 학습하고 낯선 기술을 두려워하지 않고 덤비는 태도는
              개발자에게 중요한 덕목이라고 생각합니다.
              <br /> 스스로 필요한 기술과 해야할 일을 찾아 계획을 세워 실행해 본
              제 경험은 입사 후 처음 접하는 기술과 낯선 업무에서도 팀 분위기에
              빠르게 적응하고 업무를 파악하는데 많은 도움이 될 것입니다.
              </h3>
            </div>
        </li>
      </ul>
